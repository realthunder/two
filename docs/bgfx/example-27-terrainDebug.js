...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-27-terrainDebug.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-27-terrainDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-27-terrainDebug.data');
...
var wasmBinaryFile = 'example-27-terrainDebug.wasm';
