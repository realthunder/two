...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../asmjs/bin/example-03-raymarchDebug.data';
      var REMOTE_PACKAGE_BASE = 'example-03-raymarchDebug.data';
...
Module['FS_createPath']('/shaders', 'spirv', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../asmjs/bin/example-03-raymarchDebug.data');

      };
      Module['addRunDependency']('datafile_../../asmjs/bin/example-03-raymarchDebug.data');
   ...
   loadPackage({"files": [{"filename": "/shaders/spirv/vs_raymarching.bin", "start": 0, "end": 1268, "audio": 0}, {"filename": "/shaders/spirv/fs_raymarching.bin", "start": 1268, "end": 11383, "audio": 0}], "remote_package_size": 11383, "package_uuid": "e9f31259-a8d5-4dc3-8c8d-d423a78aa3c4"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 692752,
    DYNAMIC_BASE = 5935632,
    DYNAMICTOP_PTR = 692592;
...
var wasmBinaryFile = 'example-03-raymarchDebug.wasm';
