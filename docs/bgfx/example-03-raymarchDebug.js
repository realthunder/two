...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-03-raymarchDebug.data';
...
Module['FS_createPath']("/shaders", "spirv", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-03-raymarchDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-03-raymarchDebug.data');
   ...
   loadPackage({"files": [{"filename": "/shaders/spirv/vs_raymarching.bin", "start": 0, "end": 1268, "audio": 0}, {"filename": "/shaders/spirv/fs_raymarching.bin", "start": 1268, "end": 11443, "audio": 0}], "remote_package_size": 11443, "package_uuid": "cd1b1f10-1898-4fc6-b492-9a37f95cfaa2"});
