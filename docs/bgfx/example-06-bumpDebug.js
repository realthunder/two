...
Module['FS_createPath']('/shaders', 'spirv', true, true);
   ...
   loadPackage({"files": [{"filename": "/shaders/spirv/vs_bump.bin", "start": 0, "end": 2968, "audio": 0}, {"filename": "/shaders/spirv/fs_bump.bin", "start": 2968, "end": 7907, "audio": 0}], "remote_package_size": 7907, "package_uuid": "90cb03b4-c86b-477d-9622-82f6ff36cf7e"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 720624,
    DYNAMIC_BASE = 5963504,
    DYNAMICTOP_PTR = 720464;
