...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-32-particlesDebug.data';
  ...
  Module['FS_createPath']("/", "textures", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-32-particlesDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-32-particlesDebug.data');
   ...
   loadPackage({"files": [{"filename": "/textures/particle.ktx", "start": 0, "end": 262212, "audio": 0}], "remote_package_size": 262212, "package_uuid": "0b4b632a-5206-4ec6-b529-0a6a27b34805"});
...
var wasmBinaryFile = 'example-32-particlesDebug.wasm';
