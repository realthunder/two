...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-05-instancingDebug.data';
...
Module['FS_createPath']("/shaders", "spirv", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-05-instancingDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-05-instancingDebug.data');
   ...
   loadPackage({"files": [{"filename": "/shaders/spirv/vs_instancing.bin", "start": 0, "end": 1547, "audio": 0}, {"filename": "/shaders/spirv/fs_instancing.bin", "start": 1547, "end": 2013, "audio": 0}], "remote_package_size": 2013, "package_uuid": "cddfebe7-e7ae-4baf-9edd-a90369966326"});
...
var wasmBinaryFile = 'example-05-instancingDebug.wasm';
