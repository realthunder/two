...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-35-dynamicDebug.data';
...
Module['FS_createPath']("/shaders", "spirv", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-35-dynamicDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-35-dynamicDebug.data');
   ...
   loadPackage({"files": [{"filename": "/shaders/spirv/vs_cubes.bin", "start": 0, "end": 1058, "audio": 0}, {"filename": "/shaders/spirv/fs_cubes.bin", "start": 1058, "end": 1524, "audio": 0}], "remote_package_size": 1524, "package_uuid": "b319b0ff-d209-49dc-88e8-43f45159b413"});
...
var wasmBinaryFile = 'example-35-dynamicDebug.wasm';
