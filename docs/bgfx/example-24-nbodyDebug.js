...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-24-nbodyDebug.data';
...
Module['FS_createPath']("/shaders", "spirv", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-24-nbodyDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-24-nbodyDebug.data');
   ...
   loadPackage({"files": [{"filename": "/shaders/spirv/vs_particle.bin", "start": 0, "end": 1985, "audio": 0}, {"filename": "/shaders/spirv/fs_particle.bin", "start": 1985, "end": 3424, "audio": 0}, {"filename": "/shaders/spirv/cs_init_instances.bin", "start": 3424, "end": 13985, "audio": 0}, {"filename": "/shaders/spirv/cs_update_instances.bin", "start": 13985, "end": 17786, "audio": 0}, {"filename": "/shaders/spirv/cs_indirect.bin", "start": 17786, "end": 19012, "audio": 0}], "remote_package_size": 19012, "package_uuid": "4a7a5e2c-28bd-42ad-9569-2f083e579914"});
...
var wasmBinaryFile = 'example-24-nbodyDebug.wasm';
