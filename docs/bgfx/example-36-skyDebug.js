...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../wasm/bin/example-36-skyDebug.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../wasm/bin/example-36-skyDebug.data');

      };
      Module['addRunDependency']('datafile_../../wasm/bin/example-36-skyDebug.data');
...
var wasmBinaryFile = 'example-36-skyDebug.wasm';
